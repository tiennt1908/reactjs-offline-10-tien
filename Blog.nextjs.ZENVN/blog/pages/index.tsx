...
const HomePage: NextPage<Props> = ({ latedPosts, popularPosts, generalPosts }: Props) => {
  return (
    <>
      <NextSeo title="ReactBlog Trang Chủ" description="Cập nhật thông tin tin tức, hình ảnh, video clip mới nhất, nhanh nhất và đầy đủ nhất từ nguồn ReactBlog"></NextSeo>
