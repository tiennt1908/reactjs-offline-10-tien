        ...
        <>
            <div className="add">
                <div className="add__container">
                    ...
                    <input type="text" className={"add__description " + focusClass} placeholder="Add description" onChange={(e) => setField("description", e)} />
                    <input min={1} type="number" className={"add__value " + focusClass} placeholder="Value" onChange={(e) => setField("amount", e)} />
